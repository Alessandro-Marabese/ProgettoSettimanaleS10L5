...
class TodayWeather extends Component {
    render() {
        return(
            <Col className="ps-2 text-white">
                    <h2 className="pt-3 text-white ">{this.props.name}</h2>
                    <div className="d-flex align-items-center">
                    <img src="https://openweathermap.org/img/wn/10d@2x.png" alt=""/>
                    <p id="temptoday" className="fw-bold ps-3">{parseInt(this.props.temp)} <span>°C</span> </p>
                    </div>
