        ...
        <Row className="w-75 mx-auto pt-5 ">
          <Col className="px-0 mt-4">
            <Card className="border-0 ">
              <CardImg src="https://static.vecteezy.com/system/resources/thumbnails/010/989/526/small_2x/rainy-weather-3d-rendering-isolated-on-transparent-background-ui-ux-icon-design-web-and-app-trend-png.png" className="mt-2" />
            </Card>
          </Col>
        </Row>
